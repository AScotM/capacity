...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--sort",
        choices=["mount", "total", "used", "free", "percent"],
        default="percent",
    ...
    if args.warning_threshold > args.critical_threshold:
        parser.error(f"--warning-threshold ({args.warning_threshold}) cannot be greater than --critical-threshold ({args.critical_threshold})")
